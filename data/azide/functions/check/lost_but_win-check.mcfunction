...
#红方第一局胜利，蓝方追赢二局
execute if score #round round matches 1 if score RedTeam round matches 2 run tag @a[team=blue] add lost_first
...
#蓝方第一局胜利,红方追赢二局
execute if score #round round matches 1 if score BlueTeam round matches 2 run tag @a[team=red] add lost_first

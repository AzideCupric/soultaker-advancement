...
execute as @a[team=blue] if score @s soul matches 100.. run scoreboard players add BlueTeam max_soul_num 1
        #比较满灵魂数与本队人数
execute if score #player blueplayer matches 2.. if score BlueTeam max_soul_num = #player blueplayer as @a[team=blue] run function azide:adv/soul_erupted
    #红队
        #记录当前满灵魂人数
...
execute as @a[team=red] if score @s soul matches 100.. run scoreboard players add RedTeam max_soul_num 1
        #比较当前满灵魂人数
execute if score #player blueplayer matches 2.. if score RedTeam max_soul_num = #player redplayer as @a[team=red] run function azide:adv/soul_erupted
